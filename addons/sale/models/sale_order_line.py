...
class SaleOrderLine(models.Model):
    ...
    def _compute_pricelist_item_id(self):
        ...
        no_item_lines.update({"pricelist_item_id": False})
        for (order, uom, qty), lines in groupby(
            other_lines, 
            lambda rec: (rec.order_id, rec.product_uom, rec.product_uom_qty)):
            ...
            for line in lines:
                line.pricelist_item_id = pricerules.get(line.product_id, (False, False))[1]
