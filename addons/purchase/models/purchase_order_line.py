...
class PurchaseOrderLine(models.Model):
    ...
    technical_price_unit = fields.Float(
        compute="_compute_price_unit_and_date_planned_and_name", store=True, readonly=False,
    ...
    def _compute_price_unit_and_date_planned_and_name(self):
        for line in self:
            ...
            if not line.selected_seller_id:
                ...
                line.price_unit = line.technical_price_unit = line.product_id.cost_currency_id._convert(
                    price_unit,
                    line.currency_id,
                    line.company_id,
