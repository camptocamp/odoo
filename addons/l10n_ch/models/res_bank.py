...
class ResPartnerBank(models.Model):
    ...
    def _l10n_ch_get_qr_vals(self, amount, currency, debtor_partner, free_communication, structured_communication):
        ...
        return [
            ...
            cred_zip,                                             # Creditor Postal Code (empty, since we're using combined addres elements)
            cred_city,                                            # Creditor Town (empty, since we're using combined addres elements)
            ...
            debt_city,                                            # Ultimate Debtor Postal Town
